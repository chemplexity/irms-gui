classdef IsotopeGUI < handle
    
    properties (Constant = true)
        
        name        = 'IRMS Toolbox';
        url         = '';
        version     = '0.0.1.20180222-dev';
        
        platform    = IsotopeGUI.getPlatform();
        environment = IsotopeGUI.getEnvironment();
        language    = IsotopeGUI.getLanguage();
        screensize  = IsotopeGUI.getScreenSize();
        datetime    = IsotopeGUI.getDatetime();
    ...
    methods
        ...
        function obj = IsotopeGUI(varargin)
        ...
        % Load Thermo data
        % ---------------------------------------
        function loadThermoData(obj, varargin)
    ...
    methods (Hidden = true)
        ...
        function showKeyboardShortcuts(obj, varargin)
